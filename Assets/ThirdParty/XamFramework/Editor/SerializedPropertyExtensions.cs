...
namespace Xam.Editor
{
	...
	public static class SerializedPropertyExtensions
	{
		...
		{
			Undo.RegisterCompleteObjectUndo( property.serializedObject.targetObject, $"Set {property.name}" );
		...
		static Regex m_arrayElementRegex = new Regex( @"\GArray\.data\[(\d+)\]", RegexOptions.Compiled );
		...
		static bool NextPathComponent( string propertyPath, ref int index, out PropertyPathComponent component )
		{
			...
			var arrayElementMatch = m_arrayElementRegex.Match( propertyPath, index );
